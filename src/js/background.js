import layer1 from './../assets/img/background/layer-1b.png';
import layer2 from './../assets/img/background/layer-2.png';
...
export class Background {
  constructor(game) {
    ...
    this.layerImage1.src = layer1;
    this.layerImage2 = document.getElementById('layer2');
    this.layerImage2.src = layer2;
